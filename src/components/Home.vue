  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html"><span>finsey.</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a v-scroll-to="'#index.html'">Home</a></li>
          ...
          <li class="get-started"><router-link :to="{ name: 'login' }">Sign In</router-link></li>
        </ul>
      </nav><!-- .nav-menu -->
      ...
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up" data-aos-delay="800">
            <router-link :to="{ name: 'register' }" class="btn-get-started">Register</router-link>
          </div>
        </div>
