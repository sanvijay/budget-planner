...
export default {
  ...
  computed: {
    ...
    fbScoreText() {
      return "https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffb.me%2Fteam.finsey%2F&quote=I+have+scored+" + (this.quiz.score * 10) + "+in+finsey+quiz.+Do+you+want+to+know+yours%3F+Click+http%3A%2F%2Ffinsey.in%2F%23%2Fquiz%0D%0A%0D%0Afinsey.+is+the+budget+planner+project+of+an+ideal+mind+designed+during+the+quarantine+period.+Planning+your+budget+will+make+sure+to+pass+any+critical+stages+and+have+a+peaceful+future.";
    }
  },
  components: {
    Question
